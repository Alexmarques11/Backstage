...
async function createTables() {
  try {
    ...
    // User concerts genres (many-to-many)
    await pool.query(`
      CREATE TABLE IF NOT EXISTS "user_concerts_genres" (
        "user_concert_id" INTEGER,
        "genre_id" INTEGER,
        PRIMARY KEY ("user_concert_id", "genre_id"),
        CONSTRAINT fk_user_concert FOREIGN KEY ("user_concert_id") REFERENCES "user_concerts"("id") ON DELETE CASCADE,
...
`);
    ...
    console.error("Error creating publications tables:", err);
    process.exit(1);
  }
}
